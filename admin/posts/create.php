 ...
 *
 * Crear nuevo artículo con editor WYSIWYG y módulos.
 */
...
<head>
    ...
    <title>Crear Artículo - WebNova Manager</title>
...
<nav class="navbar">
    ...
    <a href="../posts/list.php" class="btn btn-secondary">Volver a artículos</a>
</nav>

<div class="container">
    <div class="breadcrumb">
        <a href="../dashboard.php">Dashboard</a> / <a href="list.php">Artículos</a> / Crear
    </div>
    ...
    <div class="form-card">
        ...
        <div class="form-group">
            ...
            <input type="text" id="titulo" placeholder="Ej. Cómo crear páginas modernas" />
        </div>

        <div class="form-group">
            <label for="slug">Slug</label>
            <input type="text" id="slug" placeholder="Ej. crear-paginas-modernos" />
        </div>
        ...
        <div class="seo-section">
            ...
            <div class="form-group">
                ...
                <textarea id="meta_description" name="meta_description" rows="2" maxlength="160" placeholder="Descripción para motores de búsqueda"></textarea>
        ...
        <div class="form-group status-toggle">
            ...
            <label for="publicado">Publicar artículo ahora</label>
        </div>

        <div class="form-actions">
            <button type="button" class="btn btn-secondary" onclick="window.location.href='list.php'">Cancelar</button>
            <button type="button" class="btn btn-primary" onclick="submitPost()">Guardar artículo</button>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('meta_description').dispatchEvent(new Event('input'));
        ...
        .then(data => {
            if (data.success) {
                showAlert('Artículo creado con éxito. Redirigiendo...', 'success');
                setTimeout(() => {
                    window.location.href = 'list.php';
                }, 1200);
            } else {
                showAlert(data.error || 'Error al crear el artículo.', 'error');
            }
        })
