...
CREATE DATABASE IF NOT EXISTS webnova_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- =====================================================
-- TABLA: WIDGETS (modulos reutilizables)
-- =====================================================
CREATE TABLE IF NOT EXISTS widgets (
  id INT AUTO_INCREMENT PRIMARY KEY,
  nombre VARCHAR(100) NOT NULL COMMENT 'Nombre del widget',
  tipo VARCHAR(50) NOT NULL COMMENT 'Tipo del widget',
  config LONGTEXT NOT NULL COMMENT 'Configuracion en JSON',
  preview_html TEXT COMMENT 'HTML de previsualizacion',
  fecha_creacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  fecha_actualizacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_tipo (tipo)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Modulos reutilizables del CMS';
