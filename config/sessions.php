...
// Solo configurar si la sesión no ha comenzado
...
// Usar SameSite=Lax para proteger contra CSRF sin emitir cookies vacias
if (session_status() === PHP_SESSION_NONE) {
...
function validar_sesion_segura() {
    $ip_actual = $_SERVER['REMOTE_ADDR'] ?? '127.0.0.1';
